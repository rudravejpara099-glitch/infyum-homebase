export const copy = {
  ...
  hero: {
    ...
    primaryCta: "Book Your Free Conversion Audit",
    secondaryCta: "See What May Be Costing You Calls",
    microText: "Led by Harshil Bhadani · Backed by INFYUM's full execution team",
  },
  ...
  whyHarshil: {
    ...
    pullQuote:
      "More traffic will not fix a page that fails to build belief.",
  },
  ...
  whatGetFixed: {
    ...
    executionLine: "Then INFYUM helps execute the fix properly.",
    listLabel: "What gets improved inside the funnel",
    items: [
      { label: "Clarity", desc: "so the right person instantly understands what you do" },
      { label: "Perception", desc: "so the brand feels aligned with the level of the offer" },
      { label: "Structure", desc: "so the page leads buyers instead of confusing them" },
      { label: "Flow", desc: "so the next step feels easier and more natural to take" },
      {
        label: "Conversion-readiness",
        desc: "so the funnel supports booked calls instead of weakening them",
      },
    ],
    closing: "The real win is not a prettier funnel. It is a stronger buying experience.",
  },
  ...
  rightFit: {
    ...
    stateItems: [
      { label: "the offer", state: "has matured" },
      { label: "the expertise", state: "is proven" },
      { label: "the traffic", state: "is coming in" },
      { label: "but the funnel", state: "still feels one level behind" },
    ],
    consequence:
  ...
  audit: {
    ...
    body:
      "Harshil Bhadani reviews the funnel through the lens that actually affects performance:",
    lenses: [
      "message clarity",
      "trust signals",
      "premium perception",
    ...
    auditLabel: "Inside the audit, we help you uncover",
    checklistItems: [
  ...
  modal: {
    ...
    submitCta: "Book Your Free Conversion Audit",
    disclaimer:
